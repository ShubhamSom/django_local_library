...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        #  create 13 authors for pagination Tasks
        no_of_authors = 13
    ...
    def test_view_url_accessible_by_name(self):
        response = self.client.get(reverse('authors_url'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_pagination_is_ten(self):
        ...
        self.assertTrue(len(response.context['my_authors_list']) == 10)

    def test_lists_all_authors(self):
        # Get second page and confirm it has (exactly) remaining 3 items
        response = self.client.get(reverse('authors_url') + '?page=2')
        self.assertEqual(response.status_code, 200)
        self.assertTrue('is_paginated' in response.context)
        self.assertTrue(response.context['is_paginated'] is True)
        self.assertTrue(len(response.context['my_authors_list']) == 3)
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self) -> None:
        ...
        #  Create a Book
        test_author = Author.objects.create(first_name='John', last_name='Wick')
        ...
        test_book.genre.set(genre_objects)  # Direct assignment of many-to-many types not allowed.
        test_book.save()
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # check that initially we don't have any books if 'bookinstance_list' exists
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        for book in response.context['bookinstance_list']:
            if date == 0:
                ...
                self.assertTrue(date <= book.due_back)  # in order
                date = book.due_back
